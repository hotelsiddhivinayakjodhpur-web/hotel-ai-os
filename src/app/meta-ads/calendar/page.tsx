...
export default async function MetaAdsCalendarPage() {
  // Reuses the Content AI calendar, filtered to campaign-worthy channels —
  // Meta campaigns should launch alongside this content.
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Scheduled offers & festival content (next 45 days) — time Meta campaign launches to match"
      />
      <MetaAdsNav />
      ...
      <p className="mt-6 text-[11px] text-muted">
        Manage assets in <Link href="/meta-ads/queue" className="underline hover:text-text">Assets &amp; Library</Link>.
      </p>
    </div>
  );
}
