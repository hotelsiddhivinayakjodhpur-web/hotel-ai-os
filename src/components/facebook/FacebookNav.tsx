...
const TABS = [
  { href: "/facebook", label: "Dashboard" },
  { href: "/facebook/queue", label: "Content Queue" },
  { href: "/facebook/planner", label: "Planner" },
  { href: "/facebook/calendar", label: "Calendar" },
  { href: "/facebook/insights", label: "Insights" },
];
